# a script to set some HKCU registry settings that are hard to set by intune
# function by Adam Bertram, fixed by Ben https://powers-hell.com/2018/08/31/set-multiple-registry-values-to-all-users-hkcu-profiles-using-powershell-active-setup/

Start-Transcript -Path 'C:\Temp\HKCU changes.txt' -Append:$true

# define keys and values in a hashtable
$HideFileExt =          	@{'Name' = 'HideFileExt';				'Type' = 'Dword'; 'Value' = '0'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced'}
$SharingWizardOn =      	@{'Name' = 'SharingWizardOnn';			'Type' = 'Dword'; 'Value' = '0'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced'}
$ShowCortanaButton =    	@{'Name' = 'ShowCortanaButton';			'Type' = 'Dword'; 'Value' = '0'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced'}
$LaunchTo =             	@{'Name' = 'LaunchTo';					'Type' = 'Dword'; 'Value' = '1'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced'}
$MultiTaskingAltTabFilter = @{'Name' = 'MultiTaskingAltTabFilter';	'Type' = 'Dword'; 'Value' = '3'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced'}
$SearchboxTaskbarMode = 	@{'Name' = 'SearchboxTaskbarMode';		'Type' = 'Dword'; 'Value' = '1'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Search'}
$WriteZoneIdExtract = 		@{'Name' = 'WriteZoneIdExtract';		'Type' = 'Dword'; 'Value' = '1'; 'Path' = 'SOFTWARE\7-Zip\Options'}

# add the new hashtable to an array
$AllRegSettings = $HideFileExt, $SharingWizardOn, $ShowCortanaButton, $LaunchTo, $SearchboxTaskbarMode, $MultiTaskingAltTabFilter, $WriteZoneIdExtract
...
Foreach ($Setting in $AllRegSettings)
    { Set-RegistryValueForAllUsers -RegistryInstance $Setting -Verbose }
